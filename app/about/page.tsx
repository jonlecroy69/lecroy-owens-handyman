    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-slate mt-8 max-w-none text-[15px] leading-relaxed">
        <p>
          ...
          With over {BUSINESS.yearsExperience} years of combined experience, we take pride in doing high-quality work
          that homeowners can count on — whether it’s a new deck for family gatherings, fresh siding that protects
          your house, or a complete bathroom or home remodel.
        </p>

        <h2>Why Homeowners Choose Us</h2>
        <ul>
          <li><strong>Licensed &amp; Insured</strong> — {BUSINESS.license}</li>
      ...
      <div className="mt-12 rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-sm">
        <div className="font-semibold text-emerald-800 mb-1">Ready to talk about your project?</div>
        <a href={`tel:${BUSINESS.phone.replace(/-/g, "")}`} className="text-emerald-700 underline font-medium">{BUSINESS.phone}</a>
        {" "}or <a href="/#contact" className="text-emerald-700 underline font-medium">request a free quote online</a>.
      </div>
    </div>
  );
}
